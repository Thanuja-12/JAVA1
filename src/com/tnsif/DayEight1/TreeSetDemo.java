...
public class TreeSetDemo {
	...
	public static void main(String[] args) {
		...
		students.add(new Student(101, "Jayalakshmi", 87));
		students.add(new Student(104, "Bhoomikha", 71));
		students.add(new Student(104, "Bhoomikha", 71));
		students.add(new Student(103, "Hari", 67));
		students.add(new Student(102, "Anandhi", 72));
		students.add(new Student(102, "Anandhi", 72));
